...
cleanup_choice=$(zenity --list \
    ...
    --text="Choose what to clean (actual space freed shown at end):" \
    --column="Option" \
    --column="Description" \
    "Quick Cleanup" "Clean all categories safely" \
    "Temporary Files" "System temp files and caches" \
    "Browser Caches" "Chrome, Firefox, Edge, Safari, Brave, Opera" \
    "Developer Tools" "npm, pip, cargo, maven, go, gradle, docker" \
    "System Files" "Logs, thumbnails, Defender, restore points, caches" \
    --radiolist \
    --width=600 \
    --height=450 \
